...
<!-- HEALTH-REPORT-START -->
<!-- Generated by scripts/analyze_health.py on 2026-04-01 18:20 UTC -->

**Generated:** 2026-04-01 18:20 UTC &nbsp;·&nbsp; **Data window:** 7 days

### Resource Summary

| Metric | Min | Avg | Max | P95 |
| --- | ---: | ---: | ---: | ---: |
| CPU utilization | 53.7 % | 53.7 % | 53.7 % | 53.7 % |
| RAM utilization | 8.8 % | 8.8 % | 8.8 % | 8.8 % |
...
- ℹ️ Input voltage data not available (PMIC metrics not yet collected)
- ℹ️ Temperature data not available
- ✅ **CPU load healthy** — avg 53.7%, rarely exceeds 90% (0.0% of samples)
- ✅ **RAM healthy** — avg 8.8%, peak 8.8%

### Power Consumption

Power data not available (PMIC metrics not yet collected).
